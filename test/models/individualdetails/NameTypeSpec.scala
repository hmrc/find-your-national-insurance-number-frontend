...
import models.individualdetails.NameType._
import org.scalatest.flatspec.AnyFlatSpec
import org.scalatest.matchers.should.Matchers
import play.api.libs.json.Json

class NameTypeSpec extends AnyFlatSpec with Matchers {

  "NameType" should "be read correctly from JSON" in {
    val json = Json.parse("""1""")
    json.as[NameType] shouldBe RealName
