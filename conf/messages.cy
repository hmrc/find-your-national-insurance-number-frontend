...
phoneHMRCDetails.hmrcExtraHelp=Cael help <a href="{0}" class="govuk-link"> wrth ddelio â CThEF os oes gennych anghenion ychwanegol</a>
phoneHMRCDetails.findOutCallCharges=<a href="{0}" class="govuk-link">Cael gwybod am gostau galwadau.</a>
...
technicalError.tryAgain=Rhowch gynnig arall arni
technicalError.tryAgain.hint=Os gallwn gadarnhau’ch cod post ar-lein nawr, yna byddwn yn postio eich rhif Yswiriant Gwladol atoch.
...
enteredPostCodeNotFound.title=Nid yw’r cost post yr ydych wedi’i nodi yn cyd-fynd â’n cofnodion
enteredPostCodeNotFound.heading=Nid yw’r cost post yr ydych wedi’i nodi yn cyd-fynd â’n cofnodion
enteredPostCodeNotFound.inset=Gall y gwasanaeth ar-lein hwn ond anfon eich rhif Yswiriant Gwladol i’r cyfeiriad sydd gan CThEF ar gofnod i chi.
enteredPostCodeNotFound.p1=Mae angen i chi ffonio CThEF, neu argraffu a phostio ffurflen er mwyn i’ch rhif gael ei anfon i gyfeiriad gwahanol. Bydd hwnnw yn cyrraedd cyn pen 15 diwrnod gwaith.
...
confirmYourPostcode.h2=Nodwch eich cod post
